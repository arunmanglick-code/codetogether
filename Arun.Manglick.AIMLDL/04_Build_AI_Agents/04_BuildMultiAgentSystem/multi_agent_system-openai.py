...
class ClaudeAgent:
    ...
    async def call_claude(self, prompt: str, system_prompt: str = "") -> str:
        ...
        headers = {
            "Authorization": f"Bearer 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"
        }
...
async def test_api_connection():
    ...
    api_key = "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"
...
async def main():
    ...
    # api_key = os.environ.get("ANTHROPIC_API_KEY")
    # api_key = "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"
    api_key = "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"
