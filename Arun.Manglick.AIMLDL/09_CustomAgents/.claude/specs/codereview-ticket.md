...
agents:
  orchestrator: claude-code-review-orchestrator
  documentation: claude-doc-publisher
  ticketing: claude-ticket-creator
confluence:
  cloudId: "2c372697-c4a1-4192-9fa0-5cd146f9d535"
  spaceId: "3493233287"
  pageTitle-pattern: "{fileName}-am-review-{reviewDate}_{reviewTimestamp}"
  pageLayout:
