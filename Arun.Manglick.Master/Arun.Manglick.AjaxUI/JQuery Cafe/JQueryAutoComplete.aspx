<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JQueryAutoComplete.aspx.cs" Inherits="JQuery_Cafe_JQueryAutoComplete" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHeaderContent" Runat="Server">

    <script src="../JQuery/jquery-1.3.2.js" type="text/javascript"></script>
    <script src="../JQuery/jquery.autocomplete.js" type="text/javascript"></script>
    <link href="../App_Themes/MyTheme/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        //http://localhost:1856/autocomplete_ajax.cfm
