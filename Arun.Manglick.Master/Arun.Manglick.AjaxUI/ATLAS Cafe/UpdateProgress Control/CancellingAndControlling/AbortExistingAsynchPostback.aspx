    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="0">
        ...
        <tr>
            <td colspan="2" class="title" style="height: 29px">
                <asp:Label ID="lblHeader" runat="server" Text="'Cancelling An Asynchronous Postback "></asp:Label>
            </td>
        </tr>
        <!-- Row 3 -->
        <tr>
            ...
            <td>
                <div id="divform">
                    ...
                    <div class="DivClassFeature" style="width: 800px;">
                        ...
                        <ol>
                            <li>Cancelling an asynchronous postback using UpdateProgress Control</li>                            
                        </ol>
                    </div>
                    <br />
                    <br />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <fieldset>
                                    ...
                                    <br />
                                    <asp:Button ID="Button1" runat="server" CssClass="button" Text="Abort Refreshing Panel"
