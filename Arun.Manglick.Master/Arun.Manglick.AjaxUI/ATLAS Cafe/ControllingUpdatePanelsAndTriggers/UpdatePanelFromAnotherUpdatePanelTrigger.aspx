<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="UpdatePanelFromAnotherUpdatePanelTrigger.aspx.cs" Inherits="UpdatePanelFromAnotherUpdatePanelTrigger"
    Title="UpdatePanelFromAnotherUpdatePanelTrigger Page" %>
            ...
            <td>
                <div id="divform">
                    ...
                    <div class="DivClassFeature" style="width: 800px;">
                        ...
                        <ol>
                            <li>Updating a Update Panel using Trigger contained in another Update Panel</li>                            
                        </ol>
                    </div>
                    <br />
                    <br />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <fieldset>
                                    ...
                                    <asp:Button ID="Button1" CssClass="button" runat="server" Text="Refresh yourself and below Panel also" />
                                </fieldset>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                        <br />
