            ...
            <td>
                <div id="divform">                    
                    ...
                    <div id="DivNotePad" runat="server">
                        <asp:TextBox ID="txtNotePad" EnableViewState="false" runat="server" CssClass="inputfield" BorderWidth="0" TextMode="MultiLine" Width="1050px" Height="480px"></asp:TextBox>
                    </div>
                </div>
            </td>
        </tr>
