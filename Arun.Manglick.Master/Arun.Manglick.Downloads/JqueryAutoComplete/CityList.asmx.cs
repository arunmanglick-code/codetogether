...
namespace JqueryAutoComplete
{
    ...
    /// </summary>
    [WebService(Namespace = "xpanxion")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [ScriptService]    
    public class CityList : System.Web.Services.WebService
    {

        [WebMethod]
        public string GetCities(string q)
        { 
			...
			"Zoar"};
                ...
                string result = "";
                foreach (string city in cities.Where(city => city.StartsWith(q, StringComparison.InvariantCultureIgnoreCase)))
                {
                    result += "," + city;
                }
