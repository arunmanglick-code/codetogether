<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JsonSerializationOnServerCS.aspx.cs" Inherits="JsonSerializationOnServerCS" %>
...
<head id="Head1" runat="server">
    <title>JSON Serialization On Server Demo (C#)</title>
    <link href="Styles.css" rel="stylesheet" type="text/css" />
</head>
<body>

    <h2>
        <a href="http://localhost/Arun.Manglick.AjaxUI/Home.aspx">AJAX UI</a> || <a href="Default.aspx">Home</a> :: JSON Serialization On Server Demo (C#)</h2>
