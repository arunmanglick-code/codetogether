<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CustomValidation2.aspx.cs" Inherits="CustomValidation2" Title="Custom Validation" %>
                ...
                <div id="divform">
                    ...
                    <table border="0">
                        <tr>
                            ...
                            <td>
                                <asp:CustomValidator ID="ctvMoveRows" ValidateEmptyText="true" 
                            ...
                            <td align="left" class="gridcell">
                                <asp:TextBox ID="txtMoveRows" runat="server" class="inputfield"  MaxLength="4" Width="25px"></asp:TextBox>
                            </td>
                            <td align="left" class="gridcell">
                                <asp:Button ID="btnMove" runat="server" class="button" Text="Move" OnClientClick="return ValidateAll();" OnClick="btnMove_Click" />
                            </td>
                        </tr>
                    </table>
