...
**  Desc: Gets the recently created messages for the logged in user between given date range based on its role for Message Center in Arun Web.        
**        
**  Date: 16 Apr 2007        
*****************************************************************************************************************************************        
**  Change History        
...
BEGIN        
  ...
  BEGIN        
      ...
      (        
        ...
        M.MessageID,        
        M.PassCode1,
        SpecialistDisplayName = CASE  WHEN M.ArunAgentID > 0 THEN 
        ...
        LEFT OUTER JOIN VOC_ACC_CallCenter_Users AS CCU ON CCU.UserID = M.ArunAgentID			
        WHERE  M.Active = 1 
