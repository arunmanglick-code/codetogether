<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewStateOnDisability.aspx.cs" Inherits="ViewStateOnDisability" Title="ViewState Myth On Disability" %>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="0">
        ...
        <tr>
            <td colspan="2" class="title" style="height: 29px">
                <asp:Label ID="lblHeader" runat="server" Text="ViewState Myth on Disability"></asp:Label>
            </td>
        </tr>
        <!-- Row 3 -->
        <tr>
            ...
            <td>
                <div id="divform">
                    ...
                    <div class="DivClassFeature" style="width:600px;">
                        ...
                        <ol>
                            <li>ViewState Myth on Disability</li>
                            <li>Presently the ViewState is False/Disabled </li> 
                            <li>All controls are dependent on Viewstate. Here as the Viewstate is disabled, the controls will become Enable again on 'SimplePostBack' operation</li>
                            <li>Try the same after making EnableViewState="false" for the controls. Doing this will not make the controls enable on postback </li>
                            ...
                            <tr>
                                <td style="width: 10%" class="labelcolumn">
                                    <asp:Button ID="btnMakeInvisble" runat="server" EnableViewState="false" 
                                        CssClass="inputfield" Text="Make Disable" onclick="btnMakeInvisble_Click" />
                                </td>
                                <td style="width: 10%" class="labelcolumn">
