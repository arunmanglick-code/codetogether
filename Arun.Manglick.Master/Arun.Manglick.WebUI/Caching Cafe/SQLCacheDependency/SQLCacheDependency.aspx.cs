...
public partial class SQLCacheDependency : System.Web.UI.Page
{
    ...
    {
        GridView1.DataSource = GetEmptyDataTableNew();
        GridView1.DataBind();
    }
    ...
    private DataTable GetEmptyDataTable()
    {
        try
        {            
            MySQLCacheDependency obj = new MySQLCacheDependency();
    ...
    private DataTable GetEmptyDataTableNew()
    {
        try
        {
            DataTable dt = null;
            VGSService.MessageService obj = new VGSService.MessageService();
            bool res = obj.IsLabTestCollectionValid("84", String.Empty);
            if (!res)
            {
                VGSService.LabTestInstitutionCache objCache = obj.GetLatestLabTestCollection(84);
                return objCache.LabTestData;
            }
            return dt;
        }
        catch (Exception ex)
