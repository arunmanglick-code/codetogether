<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaveLooseChangesAfterSimplePostback.aspx.cs" Inherits="TemplatePage" Title="Untitled Page" %>
                        ...
                        <table border="0" width="100%" cellpadding="1" cellspacing="3">
                           ...
                           <!-- Row 3 -->
                            <tr>
                                ...
                                <td style="width: 5%" class="inputcolumn">
                                    <asp:Button ID="btnSimplePostBack" runat="server" Text="Simple Post Back" CssClass="button" OnClientClick="Javascript:SetHiddenDirtyFlag();" OnClick="btnSimplePostBack_Click" />
                                </td>
                                <td style="width: 92%" class="requiredcolumn">
