...
function DisableControls()
{
	if (document.getElementById('optContact').checked==true)
	{
		...
		document.getElementById('txtCardHolder').disabled=true
	...
	else
	{
		...
		document.getElementById('txtCardHolder').disabled=false
...
function Amountcalculate()
{
	...
	if(document.getElementById('rdoMasterAccount').checked)
	{
		...
		{
			if (!IsNumber(document.getElementById('txtMasAccAmount').value))
			{
	...
	if(document.getElementById('rdootheraccount').checked)
	{
		...
		if((document.getElementById('chkBillingAccount').checked == false)&&(document.getElementById('chkCash').checked == false)&&(document.getElementById('chkwideoff').checked == false)&&(document.getElementById('chkwiretransfer').checked == false)&&(document.getElementById('chkcheque').checked == false)&&(document.getElementById('chkcard').checked == false))
		{
			...
			//documen.getElementById('lblErrorMessage').innerText="Select Atleast one payment option";
			return false;
		}
...
function Validate()
{
	if (!IsNumeric(document.getElementById('txtMANumber').value))
	{
		alert("Master Account Number should be Numeric");
		//document.getElementById('lblErrorMessage').innerText="Master Account Number should be Numeric";
		document.getElementById('txtMANumber').focus();
		return false;
	}
	if (!IsNumeric(document.getElementById('txtMasAccAmount').value))
	{
		alert("Master Account Amount should be Numeric");
		//document.getElementById('lblErrorMessage').innerText="Master Account Amount should be Numeric";
		document.getElementById('txtMasAccAmount').focus();
		return false;
	}
	...
	if(document.getElementById('optNew') == null)
		return true;			//For RMS payment
		
	//checking for payment billing infor for ORDER
