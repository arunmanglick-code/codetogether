<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaveLooseChangesAfterCrossPostbackToChildPage.aspx.cs" Inherits="SaveLooseChangesAfterCrossPostbackToChildPage" Title="Save Loose Changes After CrossPostback To Child Page" %>
                ...
                <div id="divform">
                    ...
                    <div class="DivClassFeature" style="width:500px;">
                        ...
                        <ol>
                            ...
                            <li>Hidden Variable is used.</li>
                            <li>Test Case</li>
                            <li>Make Changes in TextBox</li>
                            <li>Click Close Button</li>
                            <li>Save Prompt - Click Cancel</li>
                            <li>Click Move Button</li>
                            <li>Click Back Button</li>
                           <li>Click Close Button</li>
                            <li>Save Prompt - This is Successful.</li>
                        </ol>
                    </div>
                    <br />
                    <br />
                        ...
                        <table border="0" width="100%" cellpadding="1" cellspacing="3">
                           ...
                           <!-- Row 3 -->
                            <tr>
                                ...
                                <td style="width: 5%" class="inputcolumn">
                                    <asp:Button ID="btnSimpleCrossPostBack" runat="server" Text="Move to Another Page" CssClass="button" OnClientClick="Javascript:SetHiddenDirtyFlag();" OnClick="btnSimpleCrossPostBack_Click" />
                                </td>
                                <td style="width: 92%" class="requiredcolumn">
                            ...
                            <tr>
                                ...
                                <td style="width: 2%" class="inputcolumn">
                                    <asp:Button ID="btnClose" runat="server" Width="150px" class="button" Text="Close" OnClientClick="Javascript:return CheckDirtyFlagBeforeRedirect();" OnClick="btnClose_Click" />
                                </td>
