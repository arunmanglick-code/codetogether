<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Information.ascx.cs" Inherits="UserControls_Cafe_UserControls_Information" EnableTheming="true" %>
    ...
    <tr>
        <td colspan="5">
            <asp:Label CssClass="formheader" Width="100%" ID="lblAuditReport" runat="server"
                Text="Information User Control"></asp:Label>
        </td>
    </tr>
    <!-- Row 2 -->
    <tr>
