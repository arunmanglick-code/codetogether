<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="OtherSnippets.aspx.cs" Inherits="OtherSnippets" Title="Other Snippets Page" %>
                           ...
                           <!-- Row 2 -->
                            <tr>
                                ...
                                <td style="width: 30%" class="labelcolumn">
                                    <asp:Label ID="lblScript1" runat="server" Text="Loop Thru All Controls In Page"></asp:Label>
                                </td>
