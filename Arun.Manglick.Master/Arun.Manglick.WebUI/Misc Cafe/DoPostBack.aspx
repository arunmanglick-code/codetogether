            ...
            <td>
                <div id="divform">
                    ...
                    <div class="DivClassFeature">
                        ...
                        <ol>
                            <li>See the use of '__doPostBack'</li>
                    ...
                    <div>
                        ...
                        <table border="0" width="100%" cellpadding="1" cellspacing="3">
                            ...
                            <tr>
                                ...
                                <td style="width: 5%" class="inputcolumn">
                                    <asp:CheckBox ID="chkCheckPass" AutoPostBack="false" runat="server" onclick="Show();" OnCheckedChanged="chkCheckPass_CheckedChanged" />            
                                </td>
                                <td style="width: 92%" class="requiredcolumn">
                                    &nbsp;
                                </td>
