<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="UsingHyperlinkField.aspx.cs" Inherits="UsingHyperlinkField"
    Title="Untitled Page" %>
                        ...
                        <div style="height:300px;">
                             <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                                ...
                                <Columns>                                    
                                    ...
                                    <asp:HyperLinkField DataNavigateUrlFields="CourseId,CourseId" Target="_blank" DataNavigateUrlFormatString="~/HTML/CenteredWindow.htm?CourseId={0}&CourseId={1}"
