<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ClientSideRowFeatures.aspx.cs" EnableEventValidation="false" Inherits="ClientSideRowFeatures" Title="Client Side" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeaderContent" runat="Server">
	...
	function Check()
	{
	    var defaultProgramsGrid = document.getElementById('<%= GridView1.ClientID %>');
	    
	    for(iCnt=2;iCnt < 5 ;iCnt++)
        {
            var financeTypeInDefaultPrograms = defaultProgramsGrid.rows[iCnt].cells[0].innerText;            
            alert( financeTypeInDefaultPrograms);             
        }
	}
</script>
                ...
                <div id="divform">
                    ...
                    <div>
                        <div class="DivClassFloat">
                            ...
                            <asp:Button ID="btnSubmit" Text="Button" runat="server" Enabled="true" OnClientClick="Check();" OnClick="btnSubmit_Click" />
                        </div>
                        <div>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>                                    
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblId" Style="visibility: hidden;" Text='<%# Eval("Id") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    </asp:TemplateField>
