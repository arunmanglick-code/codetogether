<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NonScrollingHeaderGrid.aspx.cs" Inherits="NonScrollingHeaderGrid"
    Title="Untitled Page" %>
                ...
                <div id="divform">
                    ...
                    <div class="DivClassFeature" style="width: 700px;">
                        ...
                        <ol>                          
                            ...
                            <li>Key Contributor - Below Style allpied to HeaderStyle</li>                            
                            <li>
                                .THeader
                                {
                                    position: relative;
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        <asp:Label ID="lblNoRecordFound" runat="server" Font-Size="Small" ForeColor="Green"
                                            Visible="true" Text="No Records available" Style="position: relative; text-align: center;"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
