<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PagingStyle_1.aspx.cs" Inherits="Data_Access_Cafe_Grid_View_VariousFeatures"
    Title="Untitled Page" %>
                    ...
                    <div>
                        ...
                        <div style="height:200px;">
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                ForeColor="Black" GridLines="None" PageSize="5" PagerSettings-Mode="NextPreviousFirstLast"
                                PagerSettings-Position="TopAndBottom" AutoGenerateEditButton="True" 
                                ...
                                <PagerSettings Mode="NumericFirstLast" Position="TopAndBottom" 
                                    FirstPageText="First" LastPageText="Last" PageButtonCount="2" />
                            </asp:GridView>
