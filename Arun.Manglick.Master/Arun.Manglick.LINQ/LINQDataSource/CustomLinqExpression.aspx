<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CustomLinqExpression.aspx.cs" Inherits="CustomLinqExpression" Title="Custom LINQ Expression" %>
                        ...
                        <div style="height:200px;">
                            <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                             ...
                             <asp:LinqDataSource ID="LinqDataSource1" runat="server" 
                                ...
                                EnableUpdate="True" Where="CategoryID == @CategoryID">
                                <WhereParameters>
                                    <asp:Parameter Name="CategoryID" DefaultValue="1" Type="Int32" />
                                </WhereParameters>
                            </asp:LinqDataSource>
                        </div>
                    </div>
