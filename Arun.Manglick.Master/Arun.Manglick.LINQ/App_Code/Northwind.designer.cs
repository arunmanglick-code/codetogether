...
public partial class MyProduct : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="MyProduct_Order_Detail", Storage="_Order_Details", OtherKey="ProductID")]
	...
	[Association(Name="Category_MyProduct", Storage="_Category", ThisKey="CategoryID", IsForeignKey=true)]
		...
		set
		{
						...
						|| (this._Category.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.MyProducts.Remove(this);
				}
				this._Category.Entity = value;
				if ((value != null))
				{
					value.MyProducts.Add(this);
	...
	[Association(Name="Supplier_MyProduct", Storage="_Supplier", ThisKey="SupplierID", IsForeignKey=true)]
...
public partial class Category : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<MyProduct> _Products;
	...
	public Category()
	{
		this._Products = new EntitySet<MyProduct>(new Action<MyProduct>(this.attach_Products), new Action<MyProduct>(this.detach_Products));
		OnCreated();
	}
	...
	[Association(Name="Category_MyProduct", Storage="_Products", OtherKey="CategoryID")]
	public EntitySet<MyProduct> MyProducts
	{
		get
		{
	...
	private void attach_Products(MyProduct entity)
	{
		this.SendPropertyChanging();
		entity.Category = this;
	}
	
	private void detach_Products(MyProduct entity)
	{
		this.SendPropertyChanging();
...
public partial class Order_Detail : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntityRef<MyProduct> _Product;
	...
	public Order_Detail()
	{
		...
		this._Product = default(EntityRef<MyProduct>);
		OnCreated();
	}
	...
	[Association(Name="MyProduct_Order_Detail", Storage="_Product", ThisKey="ProductID", IsForeignKey=true)]
	public MyProduct MyProduct
	{
		...
		set
		{
			MyProduct previousValue = this._Product.Entity;
			if (((previousValue != value) 
						|| (this._Product.HasLoadedOrAssignedValue == false)))
			{
				...
				this.SendPropertyChanged("MyProduct");
			}
		}
	}
...
public partial class Supplier : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<MyProduct> _MyProducts;
	...
	public Supplier()
	{
		this._MyProducts = new EntitySet<MyProduct>(new Action<MyProduct>(this.attach_MyProducts), new Action<MyProduct>(this.detach_MyProducts));
		OnCreated();
	}
	...
	[Association(Name="Supplier_MyProduct", Storage="_MyProducts", OtherKey="SupplierID")]
	public EntitySet<MyProduct> MyProducts
	{
		get
		{
