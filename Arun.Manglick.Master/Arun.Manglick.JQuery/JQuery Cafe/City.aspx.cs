...
public partial class JQuery_Cafe_City : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string[] cities = GetData();
            string result = "";
            IEnumerable<string> sequence = cities.Where(city => city.StartsWith(param, StringComparison.InvariantCultureIgnoreCase));

            foreach (string city in sequence)
            {
                result += "," + city;
            }
