...
function ShowCalendar(eP,eD,eDP,fnCB){
  var dF=document.all.ctl00_CalFrame;
  var wF=window.frames.ctl00_CalFrame;
  ...
  if(eD==g_eC && "block"==dF.style.display){
    ...
    dF.style.pixelHeight = 215;
    var dH=dF.style.pixelHeight;
    var sT=document.body.scrollTop;
    dF.style.left=eL;
    
    while(eT > (document.body.clientHeight+sT))
    {
        eT=eT-(document.body.clientHeight+sT);
    }
