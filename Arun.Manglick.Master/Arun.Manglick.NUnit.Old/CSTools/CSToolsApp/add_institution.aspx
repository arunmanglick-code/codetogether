<%@ Page Language="C#" MasterPageFile="~/cs_tool.master" AutoEventWireup="true" CodeFile="add_institution.aspx.cs"
    Inherits="Vocada.CSTools.add_institution" Theme="csTool" Title="CSTools: Add Institution" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="upnlAddInstitution" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
    ...
    var mapId  = "add_institution.aspx";
    ...
    function Navigate(page)
    {
        ...
        {
            if (page != null)
            window.location.href = "add_directory.aspx?InstitutionID=" + page;
            else
                ...
                <tr class="ContentBg">
                    <td valign="top">
                        <div style="overflow-y: Auto; height: 100%">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="=0" style="vertical-align: top;
                                margin-top: -10px;" cellspacing="0">
                                <tr>
                                    <td align="center" class="ContentBg">
                                        <fieldset class="fieldsetBlue" style="margin-left: 0px; margin-top: 0px;">
                                                ...
                                                <table id="Table1" cellspacing="1" cellpadding="2" width="90%" border="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            City:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox ID="txtCity" Columns="25" runat="server" MaxLength="50"></asp:TextBox>&nbsp;
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            Zip:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox ID="txtZip" Columns="25" runat="server" MaxLength="10"></asp:TextBox>&nbsp;
                                                        </td>
                                                        <td>
                                                            &nbsp;</td>
                                                        <td>
                                                ...
                                                <table id="Table3" cellspacing="1" cellpadding="2" width="90%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Title:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox ID="txtPrimaryTitle" Columns="25" runat="server" MaxLength="50"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            Phone:</td>
                                                        ...
                                                        <td>
                                                            Email:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox Columns="25" ID="txtPrimaryEmail" runat="server" MaxLength="100"></asp:TextBox>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Title:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox ID="txtContact1Title" Columns="25" runat="server" MaxLength="50"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            Phone:</td>
                                                        ...
                                                        <td>
                                                            Email:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox Columns="25" ID="txtContact1email" runat="server" MaxLength="100"></asp:TextBox>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Title:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox ID="txtContact2Title" Columns="25" runat="server" MaxLength="50"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            Phone:</td>
                                                        ...
                                                        <td>
                                                            Email:</td>
                                                        <td>
                                                            &nbsp;<asp:TextBox Columns="25" ID="txtContact2Email" runat="server" MaxLength="100"></asp:TextBox>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                                ...
                                                <table id="Table2" cellspacing="1" cellpadding="2" width="90%" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Batch Messages:</td>
                                                        <td>
                                                            <asp:RadioButtonList ID="rblBatchMessages" RepeatDirection="Horizontal" runat="server">
                                                                <asp:ListItem Text="On" Value="1"></asp:ListItem>
                                                                <asp:ListItem Text="Off" Value="0" Selected="True"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </td>
                                            ...
                                            <p align="center">
                                                <asp:Button CssClass="Frmbutton" ID="btnAddInstitution" Text=" Save " runat="server"
                                                    OnClick="btnAddInstitution_Click" />
                                                &nbsp;&nbsp;&nbsp;
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnAddInstitution" EventName="Click" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
