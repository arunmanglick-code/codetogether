...
/******************************File History***************************
 * File Name        : CSTUserInformation.cs
 * Author           : Suhas Tarihalkar.
 * Created Date     : 25 Feb 2008
 * Purpose          : This Class provide common properties which specify CSTools user information for User Management
 *                  : 
 *                  :
...
namespace Vocada.CSTools.Common
{
    ...
    /// </summary>
    public class CSTUserInformation
    {
