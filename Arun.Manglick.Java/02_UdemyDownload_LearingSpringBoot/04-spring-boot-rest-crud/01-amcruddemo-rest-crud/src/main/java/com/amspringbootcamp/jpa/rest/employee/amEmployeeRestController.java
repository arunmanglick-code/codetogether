...
@RestController
@RequestMapping("/amEmployeeRest")
public class amEmployeeRestController {
//    private EmployeeDAO employeeDAO;
    private EmployeeService employeeService;

//    @Autowired
//    public amEmployeeRestController(EmployeeDAO employeeDAO) {
//        this.employeeDAO = employeeDAO;
//    }

    @Autowired
    public amEmployeeRestController(EmployeeService employeeService){
